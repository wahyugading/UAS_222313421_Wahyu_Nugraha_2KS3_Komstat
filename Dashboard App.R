...
ui <- dashboardPage(
  skin = "blue",
  dashboardHeader(title = "Kerentanan Sosial ID"),
    ...
    HTML(paste0("
        <p>Peta ini memvisualisasikan hasil pengelompokan 511 kabupaten/kota ke dalam 4 klaster berdasarkan tingkat kerentanan sosial. Skor kerentanan dihitung dengan menggabungkan seluruh variabel sosial-ekonomi yang tersedia.</p>
          ...
          <ul>
              ...
              <li><span style='color:yellow;'><b>Kelompok 2 (Sedang):</b></span> Wilayah dengan skor kerentanan <strong>di atas 4.80 hingga 6.09</strong>. </li>
              <li><span style='color:orange;'><b>Kelompok 3 (Tinggi):</b></span> Wilayah dengan skor kerentanan <strong>di atas 6.09 hingga 7.47</strong>. Wilayah ini memiliki tantangan sosial-ekonomi yang cukup signifikan dan perlu perhatian. </li>
